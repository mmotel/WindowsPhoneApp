...
namespace Projekt
{
    public class QDB
    {
        ...
        public QDB()
        {
            ...
            s1.Add(new Question(1, "Which city is the capital od United Kingdom?", "Belfast", "Cardiff", "London", "Edinburgh", 3));
            s1.Add(new Question(1, "Which mountain is the Earth's heigest mountain?", "Mount Blanc", "Mount Everest", "K1", "Makalu", 2));
            s2.Add(new Question(1, "How many percents of the Earth's surface is covered by the wather?", "between 68 and 69", "between 69 and 70", "between 70 nad 71", "between 71 and 72", 3));
            s2.Add(new Question(1, "Madagascar island lies in the...", "Indian Ocean", "Pacific Ocean", "Southern Ocean", "", 1));
            s3.Add(new Question(1, "What is the elevation height of K2 mountain?", "8,811 m", "8,611 m", "", "", 2));
            ...
            s2.Add(new Question(2, "Ten meters per secound eguals...", "10 km/h", "18 km/h", "36 km/h", "", 3));
            s2.Add(new Question(2, "Which planet in Solar System is the largest (but Sun)?", "Saturn", "Jupiter", "Uranus", "", 2));
            //s3.Add(new Question(2, "C2S3Q1", "", "", "", "", 2));
            //s3.Add(new Question(2, "C2S3Q2", "", "", "", "", 1));

            // Category 3 - Music & art
            s1.Add(new Question(3, "Freddie Mercury was a lider of...", "Rolling Stones", "Pink Floyd", "Led Zeppelin", "Queen", 4));
            //s1.Add(new Question(3, "C3S1Q2", "", "", "", "", 1));
            //s2.Add(new Question(3, "C3S2Q1", "", "", "", "", 1));
            //s2.Add(new Question(3, "C3S2Q2", "", "", "", "", 1));
            //s3.Add(new Question(3, "C3S3Q1", "", "", "", "", 1));
            //s3.Add(new Question(3, "C3S3Q2", "", "", "", "", 2));
            ...
            s2.Add(new Question(4, "First Summer Olympic Games held in...", "1896", "1900", "1904", "", 1));
            s2.Add(new Question(4, "How many times Nicki Pedersen was Speedway Grand Prix Champion?", "Two", "Three", "Four", "", 2));
            s3.Add(new Question(4, "How many times did Sergey Bubka break a world record in pole vaulting (indoor and outdoor)?", "25", "35", "", "", 2));
            ...
            s2.Add(new Question(5, "How many years did Hundred Years' War last?", "100", "107", "113", "", 3));
            s3.Add(new Question(5, "In which battle did Erwin Rommel fight agains Bernard L. Montgomery in 1942?", "First Battle of El Alamein", "Second Battle of El Alamein", "", "", 2));
            ...
            s2.Add(new Question(6, "Penicillin was discovered by...", "Frederick Banting", "Robert Koch", "Alexander Fleming", "", 3));
            s3.Add(new Question(6, "Glioma attacks a tissue of...", "Brain", "Nerves", "", "", 1));
            //s3.Add(new Question(6, "C6S3Q2", "", "", "", "", 2));
        }

        public Question[] getQuestions()
        {
            Random random = new Random();            //int randomNumber = random.Next(1, 7);
